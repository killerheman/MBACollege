<div class="app-menu navbar-menu">
    ...
    <div class="navbar-brand-box">
        ...
        <a href="#" class="logo logo-dark">
            <span class="logo-sm">
                <img src="{{ asset('frontend\img\logo\logo.jpg') }}" alt="" height="50">
            </span>
            <span class="logo-lg">
                <img src="{{ asset('frontend\img\logo\logo.jpg') }}" alt="" height="50">
                <b style="color: black;">Department Of MBA</b>
            </span>
        </a>
    ...
    <div id="scrollbar">
        <div class="container-fluid">
            ...
            <ul class="navbar-nav" id="navbar-nav">
                ...
                <!-- Notice Menu -->
                <li class="nav-item">
                    <a class="nav-link menu-link" href="{{ route('admin.notice.index') }}" role="button"
                        aria-expanded="false">
                ...
                <!-- Event Menu -->
                <li class="nav-item">
                    <a class="nav-link menu-link" href="{{ route('admin.event.index') }}" role="button"
                        aria-expanded="false">
                ...
                <!-- Banner Menu -->
                <li class="nav-item">
                    <a class="nav-link menu-link" href="{{ route('admin.banner.index') }}" role="button"
                        aria-expanded="false">
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse menu-dropdown" id="sidebarDashboards1">
                        <ul class="nav nav-sm flex-column">
                            ...
                            <li class="nav-item">
                                <a href="{{route('admin.rolePermission')}}" class="nav-link" data-key="t-analytics">Role
                                    has permission</a>
                            </li>
                        </ul>
                    </div>
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse menu-dropdown" id="sidebarDashboards2">
                        <ul class="nav nav-sm flex-column">
                            <li class="nav-item">
                                <a href="{{route('admin.aqar.index')}}" class="nav-link" data-key="t-analytics">
                                    Criteria Wise</a>
                            </li>
                            <li class="nav-item">
                                <a href="{{route('admin.role.index')}}" class="nav-link" data-key="t-analytics">Session
                                    Wise</a>
                            </li>
                        </ul>
                    </div>
