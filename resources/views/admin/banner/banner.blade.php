@extends('admin.includes.layout', ['breadcrumb_title' => 'Banner'])
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-4 mb-4">
                                ...
                                <input type="text" class="form-control" name="title2" placeholder="Enter Title"
                                    value="{{ isset($editbanner) ? $editbanner->title2 : '' }}" required>
                            </div>
...
<div class="row">
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header align-items-center d-flex">
                <h4 class="card-title mb-0 flex-grow-1">Manage Banner</h4>
            </div><!-- end card header -->
            <div class="card-body">
